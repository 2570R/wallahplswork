...
class VeloController {
  ...
  public:
    ...
    VeloController(std::shared_ptr<MotionPID> pid, std::shared_ptr<AsymptoticGains> ff, float Ka, std::shared_ptr<Filter> filter)
      : pid(pid)
      , ff(ff)
      , Ka(Ka)
      , filter(filter)
    ...
    VeloController(std::shared_ptr<MotionPID> pid, std::shared_ptr<AsymptoticGains> ff, float Ka)
      : pid(pid)
      , ff(ff)
      , Ka(Ka)
    {}
